...
EXE_DEPS = assembler.o pre_assembler.o BST.o code.o fpass.o spass.o instructions.o table.o utils.o writefiles.o # Deps for exe
...
## Pre_assembler:
code.o: pre_assembler.c pre_assembler.h $(GLOBAL_DEPS)
	$(CC) -c code.c $(CFLAGS) -o $@

## Binary Search Tree:
code.o: BST.c BST.h $(GLOBAL_DEPS)
	$(CC) -c BST.c $(CFLAGS) -o $@
